        ...
        public static bool DownloadFile(HttpContext httpContext, string fileName, string filePath, long speed)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    httpContext.Response.AddHeader("Content-MD5", DW.Framework.Security.Md5.getMd5Hash(myFile));//用于验证文件
                    ...
                    {//------如果是续传请求，则获取续传的起始位置，即已经下载到客户端的字节数------
                        ...
                        startBytes = System.Convert.ToInt64(range[1]);//已经下载的字节数，即本次下载的开始位置  
